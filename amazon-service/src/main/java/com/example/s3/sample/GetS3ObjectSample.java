...
import com.example.s3.auth.AWS4SignerForAuthorizationHeader;
import com.example.s3.util.HttpUtils;
...
public class GetS3ObjectSample {
    ...
    public static void getS3Object(String bucketName, String regionName, String awsAccessKey, String awsSecretKey) {
        ...
        URL endpointUrl;
        try {
            endpointUrl = new URL("https://" + bucketName + ".s3.amazonaws.com/download.jpg");
