...
import com.example.s3.auth.AWS4SignerBase;
import com.example.s3.auth.AWS4SignerForQueryParameterAuth;
...
public class PresignedUrlSample {
     ...
     */
    public static String getPresignedUrlToS3Object(String bucketName, String fileName, String regionName, String awsAccessKey, String awsSecretKey) {
        System.out.println("******************************************************");
